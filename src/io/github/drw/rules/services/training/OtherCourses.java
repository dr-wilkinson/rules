 ...
 */
public class OtherCourses implements Courses {
    ...
    static {
        ...
        personalTable.add(new PhysicalCourse());
        personalTable.add(new PhysicalCourse());
        personalTable.add(new BladeCombatCourse());
        personalTable.add(new BrawlingCourse());
        personalTable.add(new MentalCourse());
        serviceTable.add(new ForgeryCourse());
        serviceTable.add(new GamblingCourse());
        serviceTable.add(new BrawlingCourse());
        serviceTable.add(new BladeCombatCourse());
        serviceTable.add(new GunCombatCourse());
        serviceTable.add(new BriberyCourse());
        educationTable.add(new StreetwiseCourse());
        educationTable.add(new MechanicalCourse());
        educationTable.add(new ElectronicsCourse());
        educationTable.add(new GamblingCourse());
        educationTable.add(new BrawlingCourse());
        educationTable.add(new ForgeryCourse());
        advancedTable.add(new MedicalCourse());
        advancedTable.add(new ForgeryCourse());
        advancedTable.add(new ElectronicsCourse());
        advancedTable.add(new ComputerCourse());
        advancedTable.add(new StreetwiseCourse());
        advancedTable.add(new JOATCourse());
    }
