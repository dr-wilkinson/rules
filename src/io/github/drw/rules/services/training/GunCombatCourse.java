...
import io.github.drw.rules.characters.weapons.GunSelector;

/**
 *
 * @author dr wilkinson <dr-wilkinson@users.noreply.github.com>
 */
public class GunCombatCourse implements Course {

    @Override
    public String getTitle() {
        return "Gun Combat Course";
    }

    @Override
    public void take(Character character) {
        Skills skills = character.getSkills();
        GunSelector.select(skills, new GunCombatSkill());
    }
