...
/**
 * This course enables a serving {@link Character} to gain the
 * {@link LeaderSkill}.
 *
 * @author dr wilkinson <dr-wilkinson@users.noreply.github.com>
 */
public class LeaderCourse implements Course {

    @Override
    public String getTitle() {
        return "Leadership Course";
    }

    @Override
    public void take(Character character) {
        Skill skill = new LeaderSkill();
