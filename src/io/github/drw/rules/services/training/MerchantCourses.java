 ...
 */
public class MerchantCourses implements Courses {
    ...
    static {
        ...
        personalTable.add(new BriberyCourse());
        serviceTable.add(new StewardCourse());
        serviceTable.add(new VacuumSuitCourse());
        serviceTable.add(new PhysicalCourse());
        serviceTable.add(new GunCombatCourse());
        serviceTable.add(new ElectronicsCourse());
        serviceTable.add(new JOATCourse());
        educationTable.add(new StreetwiseCourse());
        educationTable.add(new MechanicalCourse());
        educationTable.add(new ElectronicsCourse());
        educationTable.add(new NavigationCourse());
        educationTable.add(new GunneryCourse());
        educationTable.add(new MedicalCourse());
