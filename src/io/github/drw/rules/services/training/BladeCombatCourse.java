...
import io.github.drw.rules.characters.weapons.BladeSelector;

/**
 *
 * @author dr wilkinson <dr-wilkinson@users.noreply.github.com>
 */
public class BladeCombatCourse implements Course {

    @Override
    public String getTitle() {
        return "Blade Combat Course";
    }

    @Override
    public void take(Character character) {
        Skills skills = character.getSkills();
        BladeSelector.select(skills, new BladeCombatSkill());
    }
