...
/**
 * This course enable a serving {@link Character} to gain the {@link JOATSkill}.
 *
 * @author dr wilkinson <dr-wilkinson@users.noreply.github.com>
 */
public class JOATCourse implements Course {

    @Override
    public String getTitle() {
        return "Jack of all Trades Course";
    }

    @Override
    public void take(Character character) {
        Skill skill = new JOATSkill();
